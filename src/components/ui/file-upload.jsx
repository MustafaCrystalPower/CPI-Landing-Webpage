      ...
      >
        ...
        <div className="text-center">
          <div className={cn(
            ...
            hasFile ? "bg-green-100 text-green-600" : "bg-gray-100 text-gray-400 group-hover:bg-gray-200 group-hover:text-gray-500"
          )}>
            {hasFile ? <File className="h-6 w-6" /> : <Upload className="h-6 w-6" />}
          </div>
